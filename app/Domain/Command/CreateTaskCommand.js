...
var CreateTaskCommand = function(_repository) {
    this.repository = _repository;
};

CreateTaskCommand.prototype.execute = function(taskTitle, callBack) {
    this.repository.createTask(taskTitle, callBack);
};
